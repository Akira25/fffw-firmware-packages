...
c:value("false", "nein")
c.default = "false"
d = sec_auto:option(ListValue, "branch", "Branch")
d:value("release", "release")
d:value("testing", "testing")
d:value("development", "development")
d:value("costum", "--custom--")
g = sec_auto:option(Value, "branch2", "Branch2"):depends("branch", "costum")
--if d ~= "costum" then
--	g = d
--end
